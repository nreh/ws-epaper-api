...
class EPD_4in2bc_DrawTarget : public RedBlack1BitEPD {
  public:
    ...
    void Init() { controller::EPD_4IN2BC_Init(); }

    /// @brief Clear the display
    void Clear() { controller::EPD_4IN2BC_Clear(); }

    /// @brief Put the display to sleep
    void Sleep() { controller::EPD_4IN2BC_Sleep(); }

    /// @brief Display pixels in buffers to display
    void Display() { controller::EPD_4IN2BC_Display(packedBitsBlack, packedBitsRed); }
    ...
    EPD_4in2bc_DrawTarget(bool initializeSPI = true) : RedBlack1BitEPD(GetWidth(), GetHeight(), initializeSPI) {}
