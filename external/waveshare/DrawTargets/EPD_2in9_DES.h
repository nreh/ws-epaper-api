...
class EPD_2in9_DES_DrawTarget : public Black1BitEPD {
  public:
    ...
    void Init() {
        controller::EPD_2IN9_DES_Init();
    }

    /// @brief Clear the display
    void Clear() {
        controller::EPD_2IN9_DES_Clear();
    }

    /// @brief Put the display to sleep
    void Sleep() {
        controller::EPD_2IN9_DES_Sleep();
    }

    /// @brief Display pixels in buffers to display
    void Display() {
        controller::EPD_2IN9_DES_Display(packedBits);
    }
    ...
    EPD_2in9_DES_DrawTarget() : Black1BitEPD(GetWidth(), GetHeight()) {}
