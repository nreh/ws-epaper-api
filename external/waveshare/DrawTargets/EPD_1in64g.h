...
class EPD_1in64g_DrawTarget : public Color2BitEPD {
  public:
    ...
    void Init() { controller::EPD_1IN64G_Init(); }

    /// @brief Clear the display
    void Clear() { controller::EPD_1IN64G_Clear(0x1); }

    /// @brief Put the display to sleep
    void Sleep() { controller::EPD_1IN64G_Sleep(); }

    /// @brief Display pixels in buffers to display
    void Display() { controller::EPD_1IN64G_Display(packedBits); }
