...
class EPD_2in15g_DrawTarget : public Color2BitEPD {
  public:
    ...
    //  ! EPD_2IN15G_Clear(UBYTE color) was skipped because I'm not sure what arguments to pass in!

    /// @brief Initialize the display
    void Init() {
        controller::EPD_2IN15G_Init();
    }

    /// @brief Put the display to sleep
    void Sleep() {
        controller::EPD_2IN15G_Sleep();
    }

    /// @brief Display pixels in buffers to display
    void Display() {
        controller::EPD_2IN15G_Display(packedBits);
    }
    ...
    EPD_2in15g_DrawTarget() : Color2BitEPD(GetWidth(), GetHeight()) {}
